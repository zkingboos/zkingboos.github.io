      ...
      <div className="flex items-start gap-4 border-b border-zinc-200 pb-5">
        ...
        <div>
          ...
          <div className="text-xs text-zinc-500 mt-1 flex flex-wrap gap-x-2 gap-y-0.5">
            ...
            <span>·</span>
            <a href={personalInfo.github} className="hover:underline">{personalInfo.githubHandle}</a>
            <span>·</span>
            <a href={personalInfo.linkedin} className="hover:underline">{personalInfo.linkedinHandle}</a>
          </div>
        </div>
      </div>
