...
// All text supports both "en" and "pt" languages.
// ================================================
...
export const projectsContent = {
  ...
  items: [
    {
      title: "Aventrada",
      subtitle: t("High-Concurrency Ticketing Platform", "Plataforma de Tickets de Alta Concorrência"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "Affiliate",
      subtitle: t("Video Monitoring & Machine Learning Architecture", "Monitoramento de Vídeo & Arquitetura de ML"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "Launchpaid",
      subtitle: t("Creator & Affiliate Marketing Platform", "Plataforma de Marketing de Criadores & Afiliados"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "1auth",
      subtitle: t("Secure Account Management Platform", "Plataforma de Gerenciamento Seguro de Contas"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "Helix",
      subtitle: t("Discord Bot Configuration Dashboard", "Dashboard de Configuração de Bots Discord"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "RobloxMP",
      subtitle: t("Real-Money Trading & Crypto Payment Gateway", "Marketplace RMT & Gateway de Pagamento Crypto"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    {
      title: "Hapaheaven",
      subtitle: t("Web3 Social Media Platform", "Plataforma de Mídia Social Web3"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    },
    {
      ...
      subtitle: t("Real-Time Tweet Tracking System", "Sistema de Rastreamento de Tweets em Tempo Real"),
      role: t("Software Engineer", "Engenheiro de Software"),
      description: t(
    ...
    },
    {
      ...
      subtitle: t("Cloud Migration & Cost Optimization", "Migração Cloud & Otimização de Custos"),
      role: t("IT Engineer", "Engenheiro de TI"),
      description: t(
...
// Add your relevant GitHub repositories here.
// ================================================
export const openSourceContent = {
  ...
  items: [
    {
      name: "SklettLib",
      repo: "https://github.com/zkingboos/SklettLib",
      description: t(
        "A powerful Skript addon library providing advanced utilities and syntax extensions for Minecraft server scripting.",
        "Uma poderosa biblioteca addon para Skript fornecendo utilitários avançados e extensões de sintaxe para scripting de servidores Minecraft."
      ),
      language: "Java",
      stars: 0,
    },
    {
      name: "LiquidBounce",
      repo: "https://github.com/zkingboos/LiquidBounce",
      description: t(
        "Contributions to a free and open-source Minecraft Forge hacked client — focused on code refactoring and feature improvements.",
        "Contribuições para um cliente hackeado Minecraft Forge gratuito e open-source — focado em refatoração de código e melhorias de funcionalidades."
      ),
      language: "Kotlin",
      stars: 0,
    },
    ...
    // {
    //   name: "project-name",
    //   repo: "https://github.com/zkingboos/project-name",
    //   description: t("English description", "Descrição em português"),
    //   language: "TypeScript",
    //   stars: 0,
    // },
  ],
...
export const contactContent = {
  ...
  footer: t("Built with passion", "Feito com paixão"),
};
